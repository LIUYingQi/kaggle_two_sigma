...
def transform_data(X):
    ...
    X['price_per_bed'] = X['price'] / (X['bedrooms']+0.01)
    X['price_per_bath'] = X['price'] / (X['bathrooms']+0.01)
    X['price_per_room'] = X['price'] / (X['bathrooms'] + X['bedrooms']+0.01)
...
f_train_df = open("pkl_files/train_df_2.pkl",'wb')
pickle.dump(X_train,f_train_df)
f_train_df.close()

f_test_df = open("pkl_files/test_df_2.pkl",'wb')
pickle.dump(X_test,f_test_df)
f_test_df.close()

f_y = open("pkl_files/label_2.pkl",'wb')
pickle.dump(y,f_y)
f_y.close()
